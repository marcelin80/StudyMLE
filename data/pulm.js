const PULM_QUESTIONS = {
  ...
  "Lung physiology & mechanics": [
    ...
    },
    {
      ...
      options: ["Total lung capacity", "Functional residual capacity", "Inspiratory reserve volume", "Vital capacity", "Tidal volume"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Total lung capacity (TLC) is the volume at maximal inspiration where both lung and chest wall elastic recoil are directed inward.", "Correct. FRC is the equilibrium point where lung inward recoil equals chest wall outward recoil; it is the lung volume at end of normal tidal expiration.", "Incorrect. Inspiratory reserve volume is the extra volume that can be inspired above tidal volume, not an equilibrium point.", "Incorrect. Vital capacity (VC = IRV + TV + ERV) is the maximum volume exhaled after maximal inspiration; it is not an equilibrium state.", "Incorrect. Tidal volume is the volume of a normal breath (~500 mL), not a resting equilibrium volume."],
    ...
    },
    {
      ...
      options: ["It increases alveolar elastin fiber cross-linking", "It reduces surface tension at the air-liquid interface by disrupting intermolecular forces of water", "It stimulates type I pneumocyte proliferation", "It increases parasympathetic bronchomotor tone", "It converts angiotensin I to angiotensin II in the pulmonary vasculature"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Surfactant does not affect structural proteins like elastin. Elastin provides elastic recoil, not surface tension reduction.", "Correct. Surfactant (DPPC) reduces surface tension at the air-liquid interface, preventing atelectasis, especially in small alveoli where surface tension effects are greatest per the Law of Laplace.", "Incorrect. Surfactant does not stimulate pneumocyte proliferation. Type II pneumocytes produce surfactant and serve as progenitor cells for type I pneumocytes.", "Incorrect. Surfactant has no role in modulating bronchomotor tone.", "Incorrect. Angiotensin-converting enzyme (ACE) on pulmonary endothelial cells converts angiotensin I to II; this is unrelated to surfactant function."],
    ...
    },
    {
      ...
      options: ["0 mmHg", "5-15 mmHg", "25-35 mmHg", "45-55 mmHg", "Greater than 60 mmHg"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. While the calculated values may approach 0, the normal physiologic A-a gradient is 5-15 mmHg due to normal physiologic shunting.", "Correct. The normal A-a gradient is 5-15 mmHg (increases with age; roughly estimated as age/4 + 4). Values above this suggest V/Q mismatch, shunt, or diffusion impairment.", "Incorrect. An A-a gradient of 25-35 mmHg would be elevated and suggest pulmonary pathology such as V/Q mismatch or shunt.", "Incorrect. A gradient this high would indicate significant pulmonary disease.", "Incorrect. An A-a gradient >60 mmHg would suggest severe shunt physiology."],
    ...
    },
    {
      ...
      options: ["Beta-2 adrenergic receptors on bronchial smooth muscle", "Muscarinic M3 receptors on bronchial smooth muscle", "Histamine H2 receptors on bronchial epithelium", "Nicotinic receptors at the neuromuscular junction", "Alpha-1 adrenergic receptors on bronchial smooth muscle"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Beta-2 adrenergic receptors mediate bronchodilation via Gs signaling (increased cAMP); they are targeted by albuterol for asthma relief.", "Correct. Methacholine activates M3 muscarinic receptors on airway smooth muscle (Gq → IP3/Ca2+ release → bronchoconstriction), confirming airway hyperreactivity in asthma.", "Incorrect. H2 receptors are primarily found in gastric parietal cells and regulate acid secretion, not bronchoconstriction.", "Incorrect. Nicotinic receptors are at the neuromuscular junction and autonomic ganglia; methacholine has minimal nicotinic activity.", "Incorrect. Alpha-1 receptors are primarily on vascular smooth muscle and do not mediate bronchoconstriction."],
    ...
    },
    {
      ...
      options: ["Respiratory rate × tidal volume", "Respiratory rate × (tidal volume − dead space volume)", "Total lung capacity minus residual volume", "FEV1 divided by FVC", "Respiratory rate × dead space volume"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. RR × VT = minute ventilation, which includes dead space ventilation and does not accurately reflect gas exchange.", "Correct. Alveolar ventilation = RR × (VT − VD); it excludes dead space and represents the effective ventilation participating in gas exchange.", "Incorrect. TLC − RV = vital capacity, a static lung volume, not a measure of ventilation.", "Incorrect. FEV1/FVC is used to distinguish obstructive from restrictive patterns on spirometry.", "Incorrect. RR × VD = dead space ventilation, which is the wasted portion of ventilation not participating in gas exchange."],
    ...
    },
    {
      ...
      options: ["Left shift with decreased P50", "Right shift with increased P50", "No change in the curve", "Decreased oxygen-carrying capacity without curve shift", "Left shift with increased P50"],
      correctIndex: 1,
  ...
  "Obstructive lung disease": [
    {
      ...
      options: ["Leukotriene C4", "Histamine from mast cells", "Interleukin-5", "Major basic protein from eosinophils", "Tumor necrosis factor-alpha"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Leukotriene C4 contributes to bronchoconstriction and is part of the mast cell response, but histamine is the most important initial preformed mediator released upon degranulation.", "Correct. Histamine is the primary preformed mediator released immediately from mast cells during the early-phase asthmatic response, causing rapid bronchoconstriction via H1 receptors.", "Incorrect. IL-5 promotes eosinophil recruitment and activation during the late-phase response (4-8 hours later), not the acute initial phase.", "Incorrect. Major basic protein is released from eosinophils during the late-phase response and contributes to epithelial damage, not the acute bronchoconstriction.", "Incorrect. TNF-alpha is a pro-inflammatory cytokine involved in chronic airway inflammation but is not the primary mediator of acute bronchoconstriction."],
    ...
    },
    {
      ...
      options: ["Excess protease activity destroying hepatocytes", "Accumulation of misfolded protein in the endoplasmic reticulum of hepatocytes", "Autoimmune destruction of bile ducts", "Iron overload in hepatocytes", "Defective bilirubin conjugation"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Excess protease activity explains the lung damage (unopposed neutrophil elastase) but not the liver disease.", "Correct. Misfolded AAT protein (PiZZ) accumulates in the hepatocyte ER, causing hepatocyte injury, cirrhosis, and risk of hepatocellular carcinoma (toxic gain-of-function).", "Incorrect. Autoimmune bile duct destruction characterizes primary biliary cholangitis (anti-mitochondrial antibodies), not AAT deficiency.", "Incorrect. Iron overload (hemochromatosis) is a separate genetic condition involving HFE mutations.", "Incorrect. Defective bilirubin conjugation causes conditions like Gilbert syndrome or Crigler-Najjar syndrome."],
    ...
    },
    {
      ...
      options: ["Destruction of alveolar walls with airspace enlargement", "Hypertrophy and hyperplasia of mucus-secreting submucosal glands", "Non-caseating granulomas in the bronchial wall", "Kartagener triad of situs inversus, bronchiectasis, and sinusitis", "Smooth muscle hypertrophy with Curschmann spirals in sputum"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Destruction of alveolar walls characterizes emphysema ('pink puffer'), not chronic bronchitis.", "Correct. Chronic bronchitis features submucosal gland hypertrophy with an increased Reid index (>50%); goblet cell metaplasia occurs in smaller airways.", "Incorrect. Non-caseating granulomas suggest sarcoidosis, not chronic bronchitis.", "Incorrect. Kartagener syndrome involves ciliary dynein arm defects causing immotile cilia, a distinct entity from chronic bronchitis.", "Incorrect. Smooth muscle hypertrophy and Curschmann spirals (mucus plugs/shed epithelium) are features of asthma, not chronic bronchitis."],
    ...
    },
    {
      ...
      options: ["Prostaglandin E2 derived from arachidonic acid via cyclooxygenase", "Leukotriene D4 derived from arachidonic acid via 5-lipoxygenase", "Thromboxane A2 derived from arachidonic acid via cyclooxygenase", "Platelet-activating factor derived from membrane phospholipids via phospholipase A2", "Bradykinin derived from kininogen via kallikrein"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. PGE2 is produced via the COX pathway and is targeted by NSAIDs, not montelukast.", "Correct. Montelukast blocks CysLT1 receptors for leukotrienes (C4, D4, E4), which are produced from arachidonic acid via the 5-lipoxygenase pathway.", "Incorrect. TXA2 is a COX product from platelets; it is inhibited by aspirin, not montelukast.", "Incorrect. PAF is a phospholipid mediator, not a leukotriene; montelukast does not target PAF.", "Incorrect. Bradykinin is a vasoactive peptide degraded by ACE; it is unrelated to the leukotriene pathway."],
    ...
    },
    {
      ...
      options: ["Haemophilus influenzae type b", "Parainfluenza virus", "Respiratory syncytial virus", "Staphylococcus aureus", "Streptococcus pyogenes"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. H. influenzae type b classically caused epiglottitis (thumbprint sign on lateral neck X-ray, drooling, tripod position), now rare due to Hib vaccination.", "Correct. Parainfluenza virus (especially types 1 and 2) is the most common cause of croup, causing subglottic inflammation with the characteristic steeple sign.", "Incorrect. RSV is the most common cause of bronchiolitis in infants (<2 years), not croup.", "Incorrect. S. aureus can cause bacterial tracheitis, a secondary infection that may complicate croup but is not the primary etiology.", "Incorrect. S. pyogenes causes pharyngitis and peritonsillar abscess but is not a common cause of croup."],
    ...
    },
    {
      ...
      options: ["Chronic asthma with airway remodeling", "Bronchiectasis from chronic recurrent infections", "Centrilobular emphysema", "Small cell lung carcinoma with post-obstructive changes", "Idiopathic pulmonary fibrosis"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Asthma remodeling involves subepithelial fibrosis and smooth muscle hypertrophy but does not cause the permanent airway dilation with signet ring sign seen in bronchiectasis.", "Correct. Chronic recurrent infections cause irreversible airway dilation (bronchiectasis) with characteristic signet ring sign and tram-track appearance on CT.", "Incorrect. Centrilobular emphysema shows destruction of alveolar walls with airspace enlargement, not dilated thick-walled airways.", "Incorrect. Post-obstructive pneumonia can cause localized bronchiectasis, but the bilateral chronic pattern with recurrent sinopulmonary infections suggests diffuse bronchiectasis.", "Incorrect. IPF is a restrictive disease with honeycombing and lower lobe fibrosis, not dilated airways."],
    ...
    },
    {
      ...
      options: ["Staphylococcus aureus", "Pseudomonas aeruginosa", "Haemophilus influenzae", "Burkholderia cepacia", "Aspergillus fumigatus"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. S. aureus is the most common pathogen in early childhood CF but is typically supplanted by Pseudomonas in adolescence and adulthood.", "Correct. Mucoid Pseudomonas aeruginosa is the hallmark chronic colonizer in adult CF patients, forming alginate biofilms that resist clearance and antibiotics.", "Incorrect. H. influenzae can cause respiratory infections in CF, particularly in younger children, but is not the most common chronic colonizer in adults.", "Incorrect. Burkholderia cepacia is associated with CF and can cause rapid deterioration, but it is less common than Pseudomonas as a chronic colonizer.", "Incorrect. Aspergillus fumigatus can cause allergic bronchopulmonary aspergillosis (ABPA) in CF patients but does not produce mucoid colonies on MacConkey agar."],
  ...
  "Restrictive lung disease": [
    {
      ...
      options: ["Sarcoidosis", "Idiopathic pulmonary fibrosis", "Hypersensitivity pneumonitis", "Asbestosis", "Goodpasture syndrome"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Sarcoidosis typically affects younger patients (20-40 years), presents with bilateral hilar lymphadenopathy, and shows non-caseating granulomas rather than honeycombing.", "Correct. IPF presents in older adults with UIP pattern on HRCT (basilar honeycombing, traction bronchiectasis), Velcro crackles, clubbing, and restrictive PFTs.", "Incorrect. Hypersensitivity pneumonitis has an identifiable antigen exposure and often shows upper/mid-lung predominance in the chronic form.", "Incorrect. Asbestosis can mimic IPF radiographically but requires a history of asbestos exposure and may show pleural plaques.", "Incorrect. Goodpasture syndrome presents with pulmonary hemorrhage and glomerulonephritis (anti-GBM antibodies), not progressive fibrosis."],
    ...
    },
    {
      ...
      options: ["Caseating granulomas with Langhans giant cells", "Non-caseating granulomas with multinucleated giant cells", "Ferruginous bodies with dumbbell-shaped fibers", "Diffuse alveolar damage with hyaline membranes", "Eosinophilic infiltration with Charcot-Leyden crystals"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Caseating granulomas with central necrosis are characteristic of tuberculosis, not sarcoidosis. While both have granulomas, the presence of necrosis distinguishes TB.", "Correct. Non-caseating granulomas are the hallmark of sarcoidosis, distinguishing it from tuberculosis and fungal infections that produce caseating granulomas.", "Incorrect. Ferruginous bodies (asbestos bodies with golden-brown iron coating) are characteristic of asbestosis.", "Incorrect. Diffuse alveolar damage with hyaline membranes is the pathologic hallmark of acute respiratory distress syndrome (ARDS).", "Incorrect. Eosinophilic infiltration with Charcot-Leyden crystals is associated with asthma and eosinophilic lung diseases."],
    ...
    },
    {
      ...
      options: ["Upper lobe apices", "Main bronchi", "Bifurcation of respiratory bronchioles and alveolar ducts", "Hilum of the lung", "Pleural surface only"],
      correctIndex: 2,
      ...
      optionExplanations: ["Incorrect. Upper lobe disease is characteristic of silicosis and coal workers' pneumoconiosis, not asbestosis.", "Incorrect. Main bronchi are large conducting airways; asbestos fibers are small enough to reach distal airways and alveolar ducts.", "Correct. Asbestos fibers deposit at respiratory bronchiole and alveolar duct bifurcations, initiating inflammation and fibrosis that progresses to involve the lower lobes.", "Incorrect. Hilar involvement with lymphadenopathy is more characteristic of sarcoidosis and silicosis ('eggshell calcifications').", "Incorrect. While asbestos causes pleural plaques and mesothelioma, parenchymal asbestosis begins at bronchiolar bifurcations, not solely the pleural surface."],
    ...
    },
    {
      ...
      options: ["Type I (IgE-mediated)", "Type II (antibody-mediated cytotoxicity)", "Type III (immune complex-mediated)", "Type IV (cell-mediated/delayed)", "Type I and Type IV combined"],
      correctIndex: 2,
      ...
      optionExplanations: ["Incorrect. Type I (IgE-mediated) reactions cause immediate symptoms within minutes (allergic asthma, anaphylaxis), not the 4-8 hour delay seen here.", "Incorrect. Type II reactions involve antibodies against cell surface antigens (autoimmune hemolytic anemia, transfusion reactions) and are not involved in HP.", "Correct. The acute phase of HP (4-8 hr delay) is primarily a type III immune complex reaction with IgG precipitins against the offending antigen.", "Incorrect. Type IV reactions contribute to the chronic granulomatous phase of HP but are not the primary driver of the acute 4-8 hour reaction.", "Incorrect. While HP involves both type III and IV reactions, the acute phase with 4-8 hour onset is predominantly type III."],
    ...
    },
    {
      ...
      options: ["Eosinophils releasing major basic protein", "Macrophages unable to digest silica particles, triggering fibrogenic cytokine release", "Neutrophils releasing myeloperoxidase", "Mast cells degranulating in response to IgE", "B cells producing anti-silica antibodies"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Eosinophils are involved in parasitic infections and allergic reactions, not silicosis.", "Correct. Macrophages engulf silica but cannot digest it; this activates the NLRP3 inflammasome and releases fibrogenic cytokines, driving progressive fibrosis.", "Incorrect. While neutrophils contribute to acute inflammation, macrophages and their inability to clear silica are the central pathogenic mechanism.", "Incorrect. Mast cell degranulation is an IgE-mediated type I hypersensitivity reaction, not involved in silicosis.", "Incorrect. Silicosis is not antibody-mediated; it is driven by macrophage-silica interactions."],
    ...
    },
    {
      ...
      options: ["Usual interstitial pneumonia (UIP)", "Nonspecific interstitial pneumonia (NSIP)", "Cryptogenic organizing pneumonia (COP)", "Lymphocytic interstitial pneumonia (LIP)", "Desquamative interstitial pneumonia (DIP)"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. UIP is the pattern seen in idiopathic pulmonary fibrosis. While it can occur in scleroderma, NSIP is significantly more common.", "Correct. NSIP is the most common interstitial lung disease pattern in scleroderma and other connective tissue diseases, showing temporally uniform inflammation/fibrosis.", "Incorrect. COP (previously BOOP) presents with patchy consolidation and is associated with infection, drugs, and connective tissue diseases but is not the most common pattern in scleroderma.", "Incorrect. LIP is associated with Sjögren syndrome and lymphoproliferative disorders, not typically scleroderma.", "Incorrect. DIP is most commonly associated with cigarette smoking and shows uniform accumulation of macrophages in alveolar spaces."],
    ...
    },
    {
      ...
      options: ["Granuloma formation in the interstitium", "Hyaline membranes lining the alveolar ducts and alveoli", "Honeycomb fibrosis in the lung periphery", "Mucus plugging of the bronchioles", "Cavitary necrosis of the lung parenchyma"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Granulomas are characteristic of sarcoidosis and tuberculosis, not ARDS.", "Correct. Hyaline membranes (diffuse alveolar damage) are the pathologic hallmark of the exudative phase of ARDS.", "Incorrect. Honeycomb fibrosis is a late-stage finding in idiopathic pulmonary fibrosis (UIP pattern), not the acute phase of ARDS.", "Incorrect. Mucus plugging is a feature of asthma and chronic bronchitis, not ARDS.", "Incorrect. Cavitary necrosis occurs in tuberculosis, fungal infections, and certain malignancies, not typical ARDS."],
    ...
    },
    {
      ...
      options: ["IgE-mediated mast cell degranulation", "Direct cytotoxic injury to pneumocytes with phospholipid accumulation", "Immune complex deposition in alveolar capillaries", "Inhibition of angiotensin-converting enzyme", "Activation of the complement cascade"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Amiodarone toxicity is not IgE-mediated; it results from direct cellular toxicity.", "Correct. Amiodarone causes direct cytotoxic injury via phospholipid accumulation (phospholipidosis) in pneumocytes and macrophages, producing foamy macrophages on biopsy.", "Incorrect. Immune complex deposition (type III hypersensitivity) is not the mechanism of amiodarone lung toxicity.", "Incorrect. ACE inhibitors can cause dry cough (via bradykinin accumulation) but amiodarone toxicity has a different mechanism.", "Incorrect. Complement activation is not the primary mechanism of amiodarone-induced pulmonary damage."],
  ...
  "Pulmonary vascular disease": [
    {
      ...
      options: ["Right atrial mural thrombus", "Deep veins of the lower extremities", "Left ventricular aneurysm", "Superior vena cava", "Jugular veins"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Right atrial thrombi can embolize to the lungs but are much less common than lower extremity DVT as a source of PE.", "Correct. >95% of pulmonary emboli originate from DVTs in the deep veins of the lower extremities (iliofemoral veins), especially in post-surgical patients with Virchow's triad.", "Incorrect. Left ventricular thrombi embolize systemically (stroke, limb ischemia), not to the pulmonary vasculature.", "Incorrect. Superior vena cava thrombosis can occur with central venous catheters but is a rare source of PE compared to lower extremity DVT.", "Incorrect. Jugular vein thrombosis is uncommon and accounts for a very small fraction of pulmonary emboli."],
    ...
    },
    {
      ...
      options: ["Granulomatous vasculitis with multinucleated giant cells", "Plexiform lesions representing abnormal vascular channels within the arterial wall", "Fibrinoid necrosis of pulmonary veins", "Atheromatous plaques in large pulmonary arteries", "Amyloid deposition in the pulmonary vasculature"],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ["Placement of an inferior vena cava filter", "Intravenous heparin followed by warfarin", "Systemic thrombolytic therapy with tissue plasminogen activator", "Oral rivaroxaban alone", "Observation with serial echocardiograms"],
      correctIndex: 2,
      ...
      optionExplanations: ["Incorrect. IVC filters prevent recurrent PE but do not treat the current massive embolism or restore hemodynamics.", "Incorrect. Heparin followed by warfarin is standard for hemodynamically stable PE (submassive or low-risk), but this patient needs more aggressive treatment for massive PE with shock.", "Correct. Systemic thrombolysis (tPA) is the treatment of choice for massive PE with hemodynamic instability, as it rapidly dissolves the clot and restores pulmonary blood flow.", "Incorrect. Oral anticoagulation alone is insufficient for massive PE with hemodynamic compromise.", "Incorrect. Observation is inappropriate for a hemodynamically unstable patient with massive PE; this requires emergent intervention."],
    ...
    },
    {
      ...
      options: ["3 Wood units", "5 Wood units", "9 Wood units", "12 Wood units", "15 Wood units"],
      correctIndex: 2,
      ...
      optionExplanations: ["Incorrect. PVR = (48 − 12)/4 = 9, not 3 Wood units. A PVR of 3 Wood units is at the upper limit of normal.", "Incorrect. A calculation error; PVR = 36/4 = 9, not 5.", "Correct. PVR = (mPAP − PCWP) / CO = (48 − 12) / 4 = 9 Wood units, significantly elevated above normal (<3 Wood units).", "Incorrect. 12 Wood units would require a mPAP − PCWP of 48, but the transpulmonary gradient is 36 mmHg.", "Incorrect. 15 Wood units would require a transpulmonary gradient of 60 mmHg."],
    ...
    },
    {
      ...
      options: ["Mitral valve vegetation embolizing to the lungs", "Tricuspid valve vegetation with septic pulmonary emboli", "Aortic valve vegetation with systemic embolization", "Left atrial myxoma fragments", "Patent foramen ovale with paradoxical embolism"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Mitral valve vegetations embolize systemically (brain, kidneys, spleen), not to the lungs, since the mitral valve is on the left side of the heart.", "Correct. Tricuspid valve vegetations (right-sided endocarditis in IVDU) embolize to the pulmonary vasculature, causing septic pulmonary emboli with nodular cavitating lesions.", "Incorrect. Aortic valve vegetations cause systemic emboli (stroke, renal infarcts), not pulmonary nodules.", "Incorrect. Left atrial myxoma can cause systemic embolization and obstruction of the mitral valve but does not cause pulmonary septic emboli.", "Incorrect. Paradoxical embolism through a PFO sends venous thrombi to the systemic circulation, not to the lungs."],
    ...
    },
    {
      ...
      options: ["Budd-Chiari syndrome", "Trousseau syndrome", "May-Thurner syndrome", "Paget-Schroetter syndrome", "Behçet syndrome"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Budd-Chiari syndrome is hepatic vein thrombosis causing hepatomegaly, ascites, and abdominal pain.", "Correct. Trousseau syndrome is migratory superficial thrombophlebitis associated with visceral malignancy (especially mucin-secreting adenocarcinomas like pancreatic cancer).", "Incorrect. May-Thurner syndrome involves compression of the left iliac vein by the right iliac artery, predisposing to left-sided DVT.", "Incorrect. Paget-Schroetter syndrome is effort-related thrombosis of the axillary-subclavian vein, typically in young athletes.", "Incorrect. Behçet syndrome is a vasculitis with oral ulcers, genital ulcers, and uveitis that can cause venous thrombosis but is not specific to malignancy."],
    ...
    },
    {
      ...
      question: "Which of the following is the most likely diagnosis?",
      options: ["Acute pulmonary thromboembolism", "Fat embolism syndrome", "Air embolism", "Amniotic fluid embolism", "Septic embolism"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. While PE is common post-operatively, the triad of respiratory distress, neurologic changes, and petechial rash 2 days after long bone fracture is classic for fat embolism, not thromboembolism.", "Correct. Fat embolism syndrome presents 24-72 hrs after long bone fracture with the classic triad: respiratory distress, neurologic symptoms, and petechial rash.", "Incorrect. Air embolism occurs during surgical procedures, central line placement, or diving accidents and presents with acute cardiovascular collapse, not the gradual triad described.", "Incorrect. Amniotic fluid embolism occurs during labor/delivery or shortly after, not after orthopedic surgery.", "Incorrect. Septic embolism typically occurs with infective endocarditis or infected IV lines and presents with fever and multifocal infectious complications."],
    ...
    },
    {
      ...
      options: ["Increased nitric oxide production causing vasodilation", "Inhibition of oxygen-sensitive potassium channels in pulmonary arterial smooth muscle cells", "Activation of beta-2 adrenergic receptors on vascular smooth muscle", "Release of prostacyclin from endothelial cells", "Decreased endothelin-1 production by pulmonary endothelium"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Nitric oxide causes vasodilation, not vasoconstriction; HPV involves reduced NO availability.", "Correct. Hypoxia inhibits O2-sensitive K+ channels in pulmonary artery smooth muscle → membrane depolarization → Ca2+ influx → vasoconstriction. This diverts blood to better-ventilated areas.", "Incorrect. Beta-2 receptors cause vasodilation and bronchodilation; they are not the mechanism of HPV.", "Incorrect. Prostacyclin (PGI2) causes vasodilation and inhibits platelet aggregation; it opposes HPV.", "Incorrect. Endothelin-1 is a vasoconstrictor and its levels increase (not decrease) in response to hypoxia, contributing to HPV."],
    ...
    },
    {
      ...
      options: ["The lupus anticoagulant inhibits factor XII in vivo, causing both bleeding and clotting", "The lupus anticoagulant interferes with the phospholipid-dependent steps of the aPTT assay in vitro but promotes thrombosis in vivo", "Anti-cardiolipin antibodies directly activate thrombin, shortening the PT but prolonging the aPTT", "The patient has concurrent hemophilia and antiphospholipid syndrome", "Warfarin therapy is simultaneously prolonging the aPTT"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. The lupus anticoagulant does not specifically inhibit factor XII in a clinically meaningful way; its in vitro effect is on phospholipid-dependent assay steps.", "Correct. Lupus anticoagulant antibodies interfere with the phospholipid-dependent aPTT assay in vitro (prolonged aPTT) but paradoxically promote thrombosis in vivo by activating endothelium and inhibiting anticoagulant pathways.", "Incorrect. Anti-cardiolipin antibodies do not directly activate thrombin; the mechanism involves interference with phospholipid surfaces.", "Incorrect. The non-correction on mixing studies indicates an inhibitor (lupus anticoagulant), not a factor deficiency like hemophilia.", "Incorrect. There is no mention of warfarin therapy; the aPTT prolongation is due to the lupus anticoagulant."],
  ...
  "Lung neoplasms": [
    ...
    },
    {
      ...
      question: "Which of the following is the most likely diagnosis?",
      options: ["Squamous cell carcinoma", "Adenocarcinoma", "Small cell carcinoma", "Mesothelioma", "Metastatic colon cancer"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Squamous cell carcinoma is typically central with keratin pearls and intercellular bridges; it stains positive for p40 and p63, not TTF-1.", "Correct. Peripheral glandular tumor with mucin production, TTF-1+, and napsin A+ in a non-smoking woman is classic for pulmonary adenocarcinoma.", "Incorrect. Small cell carcinoma shows neuroendocrine features (chromogranin, synaptophysin), not glandular differentiation.", "Incorrect. Mesothelioma arises from pleura with asbestos exposure and stains positive for calretinin, cytokeratin 5/6, and WT-1; it is TTF-1 negative.", "Incorrect. Metastatic colon cancer stains positive for CDX2 and CK20 and is TTF-1 negative."],
    ...
    },
    {
      ...
      options: ["Clara cells producing excess surfactant", "Neuroendocrine (Kulchitsky) cells producing ADH", "Type II pneumocytes producing alpha-fetoprotein", "Squamous epithelial cells producing PTHrP", "Alveolar macrophages producing IL-6"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Clara (club) cells secrete proteins in bronchioles; they are not the origin of SCLC and do not produce surfactant.", "Correct. SCLC arises from neuroendocrine (Kulchitsky) cells and can produce ectopic ADH (SIADH → hyponatremia) or ACTH (Cushing syndrome).", "Incorrect. Type II pneumocytes produce surfactant and are associated with adenocarcinoma, not SCLC. AFP is associated with hepatocellular carcinoma and germ cell tumors.", "Incorrect. Squamous cell carcinoma (not SCLC) produces PTHrP causing hypercalcemia.", "Incorrect. Alveolar macrophages are not the cell of origin for any primary lung cancer."],
    ...
    },
    {
      ...
      options: ["Cardiac tamponade", "Superior vena cava syndrome", "Tension pneumothorax", "Aortic dissection", "Chylothorax"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Cardiac tamponade causes Beck's triad (hypotension, JVD, muffled heart sounds) and pulsus paradoxus, not facial swelling with upper extremity cyanosis.", "Correct. SVC syndrome presents with facial/upper extremity edema, cyanosis, and venous congestion due to obstruction of the SVC by mediastinal malignancy.", "Incorrect. Tension pneumothorax causes unilateral absent breath sounds, tracheal deviation, and hypotension, not bilateral facial swelling.", "Incorrect. Aortic dissection presents with tearing chest pain radiating to the back with blood pressure differentials between arms.", "Incorrect. Chylothorax is accumulation of lymphatic fluid in the pleural space from thoracic duct injury, not SVC obstruction."],
    ...
    },
    {
      ...
      question: "Which of the following is the most likely diagnosis?",
      options: ["Squamous cell carcinoma", "Typical carcinoid tumor", "Small cell lung carcinoma", "Hamartoma", "Atypical carcinoid tumor"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Squamous cell carcinoma shows keratin pearls, intercellular bridges, and high mitotic activity; it is strongly associated with smoking.", "Correct. Typical carcinoid: low-grade neuroendocrine tumor, central endobronchial, salt-and-pepper chromatin, chromogranin+, low Ki-67 (<5%), not smoking-related, excellent prognosis.", "Incorrect. SCLC is a high-grade neuroendocrine tumor with a very high Ki-67 (>50%), nuclear molding, frequent mitoses, and necrosis.", "Incorrect. Hamartoma is the most common benign lung tumor, composed of cartilage, fat, and connective tissue with a 'popcorn' calcification pattern on imaging.", "Incorrect. Atypical carcinoid has 2-10 mitoses per 2 mm² and/or focal necrosis, with a higher Ki-67 and worse prognosis than typical carcinoid."],
    ...
    },
    {
      ...
      question: "Which of the following is the most likely diagnosis?",
      options: ["Metastatic lung adenocarcinoma to the pleura", "Malignant mesothelioma", "Squamous cell carcinoma of the lung", "Thymoma with pleural extension", "Pleural lipoma"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Metastatic adenocarcinoma to the pleura would stain positive for TTF-1 and CEA, not calretinin and CK 5/6.", "Correct. Asbestos exposure + circumferential pleural thickening + calretinin+/CK 5/6+ = malignant mesothelioma.", "Incorrect. Squamous cell carcinoma is a parenchymal lung tumor, not a primary pleural malignancy.", "Incorrect. Thymoma is an anterior mediastinal tumor; while it can invade the pleura, it does not stain for calretinin.", "Incorrect. Pleural lipoma is a benign fatty tumor that does not cause circumferential thickening or bloody effusion."],
    ...
    },
    {
      ...
      options: ["Autoantibodies against postsynaptic acetylcholine receptors", "Autoantibodies against presynaptic voltage-gated calcium channels reducing acetylcholine release", "Direct tumor invasion of the neuromuscular junction", "Demyelination of motor neurons by anti-myelin antibodies", "Destruction of anterior horn cells by paraneoplastic antibodies"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Anti-AChR antibodies characterize myasthenia gravis, which causes fatigable weakness that worsens with use and shows a decremental response on EMG.", "Correct. LEMS involves anti-VGCC antibodies → reduced presynaptic Ca2+ influx → decreased ACh release. Improves with use because repeated stimulation accumulates calcium.", "Incorrect. SCLC can metastasize widely but does not directly invade the neuromuscular junction.", "Incorrect. Demyelination of motor neurons would produce upper or lower motor neuron signs, not the facilitation pattern of LEMS.", "Incorrect. Anterior horn cell destruction causes lower motor neuron disease (like ALS), not the fatigability pattern seen here."],
    ...
    },
    {
      ...
      question: "Which of the following is the most likely diagnosis?",
      options: ["Chondrosarcoma", "Pulmonary hamartoma", "Carcinoid tumor", "Granuloma", "Bronchogenic cyst"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Chondrosarcoma is a malignant cartilaginous tumor primarily of bone, extremely rare in the lung, and would show cytologic atypia.", "Correct. Pulmonary hamartoma is the most common benign lung tumor, with disorganized cartilage, fat, and fibrous tissue and characteristic popcorn calcification.", "Incorrect. Carcinoid tumors are neuroendocrine neoplasms with uniform cells and salt-and-pepper chromatin; they do not contain cartilage or fat.", "Incorrect. Granulomas are inflammatory lesions (collections of epithelioid macrophages) seen in TB and sarcoidosis, not neoplasms with cartilage/fat.", "Incorrect. Bronchogenic cysts are developmental anomalies lined by respiratory epithelium, not composed of cartilage and fat."],
  ...
  "Acid-base & gas exchange": [
    {
      ...
      options: ["Respiratory acidosis with metabolic compensation", "Metabolic acidosis with respiratory compensation", "Mixed respiratory and metabolic acidosis", "Metabolic alkalosis with respiratory compensation", "Respiratory alkalosis with metabolic compensation"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. In respiratory acidosis, PaCO2 would be elevated, not reduced.", "Correct. DKA causes high anion gap metabolic acidosis (ketoacids); Kussmaul respirations provide appropriate respiratory compensation (↓ PaCO2).", "Incorrect. In mixed acidosis, both PaCO2 would be elevated and HCO3- decreased; here the low PaCO2 reflects compensation.", "Incorrect. Metabolic alkalosis would show elevated pH and HCO3-, the opposite of this patient's values.", "Incorrect. Respiratory alkalosis would show low PaCO2 as the primary disorder with compensatory HCO3- decrease, but the clinical picture and severely low HCO3- indicate primary metabolic acidosis."],
    ...
    },
    {
      ...
      options: ["Hyperkalemia causing nerve membrane depolarization", "Respiratory alkalosis decreasing ionized calcium levels", "Metabolic acidosis causing potassium shift into cells", "Hypoxemia causing peripheral nerve ischemia", "Hypernatremia causing cerebral dehydration"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Alkalosis causes hypokalemia (potassium shifts into cells), not hyperkalemia.", "Correct. Alkalosis increases calcium binding to albumin → decreased ionized Ca2+ → increased neuromuscular excitability → paresthesias and tetany.", "Incorrect. This patient has respiratory alkalosis, not metabolic acidosis.", "Incorrect. PaO2 is 110 mmHg (normal/elevated); hypoxemia is not present.", "Incorrect. There is no information suggesting hypernatremia; the mechanism is alkalosis-induced ionized hypocalcemia."],
    ...
    },
    {
      ...
      options: ["Acute respiratory acidosis only", "Chronic respiratory acidosis with acute exacerbation", "Metabolic alkalosis with respiratory compensation", "Acute metabolic acidosis", "Chronic respiratory acidosis with adequate compensation"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. In acute respiratory acidosis, HCO3- rises only 1 mEq/L per 10 mmHg PaCO2 increase; HCO3- of 32 suggests chronic compensation.", "Correct. The elevated HCO3- (32) indicates chronic renal compensation, while the severely acidotic pH (7.22) indicates an acute worsening on top of chronic retention.", "Incorrect. The primary disorder is respiratory acidosis (elevated PaCO2), not metabolic alkalosis.", "Incorrect. HCO3- is elevated (32), not decreased as in metabolic acidosis.", "Incorrect. If compensation were adequate, the pH would be near normal (7.35-7.38); the pH of 7.22 indicates inadequate compensation due to an acute component."],
    ...
    },
    {
      ...
      options: ["Ketoacids from starvation", "Lactic acid from tissue hypoperfusion", "Ingestion of methanol", "Renal tubular acidosis", "Excess saline administration"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Starvation ketoacidosis would not typically produce lactate of 8 mmol/L and is mild compared to this severe acidosis.", "Correct. Septic shock → tissue hypoperfusion → anaerobic metabolism → lactic acidosis (type A). Lactate of 8 mmol/L confirms this as the primary cause.", "Incorrect. Methanol ingestion causes high AG acidosis with osmol gap, visual disturbances, and formic acid production, not septic shock.", "Incorrect. Renal tubular acidosis causes a normal anion gap (hyperchloremic) metabolic acidosis.", "Incorrect. Excess saline causes hyperchloremic normal anion gap acidosis (dilutional), not a high AG acidosis."],
    ...
    },
    {
      ...
      options: ["Direct stimulation of bicarbonate reabsorption in the proximal tubule", "Inhibition of the Na+/K+/2Cl- cotransporter causing volume contraction and increased aldosterone activity", "Blockade of the epithelial sodium channel in the collecting duct", "Inhibition of carbonic anhydrase in the proximal tubule", "Direct inhibition of hydrogen ion secretion in the distal nephron"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Furosemide does not directly stimulate proximal bicarbonate reabsorption.", "Correct. Furosemide blocks NKCC2 → volume depletion → ↑ aldosterone → ↑ distal H+/K+ secretion → metabolic alkalosis + hypokalemia (contraction alkalosis).", "Incorrect. ENaC blockade (by amiloride, triamterene) would cause hyperkalemia and metabolic acidosis, the opposite effect.", "Incorrect. Carbonic anhydrase inhibitors (acetazolamide) cause metabolic acidosis by preventing bicarbonate reabsorption.", "Incorrect. Furosemide does not directly inhibit H+ secretion; it indirectly promotes H+ secretion via aldosterone activation."],
    ...
    },
    {
      ...
      options: ["Aspirin (salicylate)", "Ethylene glycol", "Isopropyl alcohol", "Acetaminophen", "Iron tablets"],
      correctIndex: 1,
      ...
      optionExplanations: ["Incorrect. Salicylate toxicity causes a mixed respiratory alkalosis and high AG metabolic acidosis but does not typically produce a significant osmol gap.", "Correct. Ethylene glycol causes high AG metabolic acidosis + elevated osmol gap. Metabolites: glycolic acid → oxalic acid → calcium oxalate crystals in urine.", "Incorrect. Isopropyl alcohol causes an elevated osmol gap with ketosis but NOT metabolic acidosis (isopropanol → acetone, which does not generate acid).", "Incorrect. Acetaminophen causes hepatotoxicity (NAPQI metabolite) but not high AG acidosis with osmol gap.", "Incorrect. Iron toxicity causes GI hemorrhage and high AG acidosis but does not produce an osmol gap."],
